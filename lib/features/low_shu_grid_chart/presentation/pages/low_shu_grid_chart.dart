...
class LoChart extends StatefulWidget {
  const LoChart({super.key});

  @override
  State<LoChart> createState() => _NameState();
}

class _NameState extends State<LoChart> with TickerProviderStateMixin {
  ...
  final jobRoleCtrl6 = TextEditingController();
